...
def register():
    ...
    if form.validate_on_submit():
        ...
        if user:
            flash("This email already exists. Please try log in instead.")
...
def login():
    ...
    if form.validate_on_submit():
        ...
        user = User.query.filter_by(email=email).first()
        if not user:
            flash("This email doesn't exists. Make sure you enter the correct email.")
            return redirect(url_for("login"))
        else:
            if check_password_hash(user.password, password):
                ...
                flash("Incorrect password. Please try log in again.")
                return redirect(url_for("login"))
